...
def main():
    ...
    parser.add_argument('--dist', nargs=2, type=int)
    ...
    with open(args.pred) as pred, open(args.gold) as gold:
        ...
        for line in pred:
            ...
            if line[5] == args.label and (args.dist[0] <= int(line[4]) < args.dist[1]):
        ...
        for line2 in gold:
            ...
            if line2[5] == args.label and (args.dist[0] <= int(line2[4]) < args.dist[1]):
